        ...
        <div className='movie'>
            {
                vote_average ? (
                        ...
                        <div className="movie_img_and_content">
                            ...
                            <div className="movie_content">
                                ...
                                <div className="crew">
                                    ...
                                    <div className="crew_members_div">
                                        {
                            ...
                            <div className="cast_content">
                                {
                                    shortened_cast_list.map( ({ id, profile_path, name, character }) => <div key={id} className='cast_member'>
                                        ...
                                        <div className="cast_details">
                                            ...
                                            { character ? ( <span className='cast_character_name'> as {character}</span> ) : null }
                                        </div>
                                    </div> )
                                }
                            </div>
                    ...
                    <div className='movie_loading'>
                        <h2>Almost there I can almost see the movie info right now...</h2>
                    </div>
                )
            }
        </div>
